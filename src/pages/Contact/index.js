            ...
            <div className="d-flex justify-content-around flex-wrap mt-5">
                ...
                <div className="flip-card mb-4">
                    <div className="flip-card-inner a">
                      ...
                      <div className="flip-card-back" style={{backgroundColor:'#f0b042'}} onTouchStart={a}>
                        <h1>GitHub</h1> 
                        <p>View My Code</p> 
                ...
                <div className="flip-card mb-4">
                    <div className="flip-card-inner b">
                      ...
                      <div className="flip-card-back" style={{backgroundColor:'#ea5642'}} onTouchStart={b}>
                        <h1>linkedIn</h1> 
                ...
                <div className="flip-card mb-4">
                    <div className="flip-card-inner c">
                      ...
                      <div className="flip-card-back" style={{backgroundColor:'#4FB99F'}} onTouchStart={c}>
                        <h1>Email</h1> 
                        <p>Email Me</p> 
                ...
                <div className="flip-card mb-4">
                    <div className="flip-card-inner d">
                      ...
                      <div className="flip-card-back" style={{backgroundColor:'#2a5e9f'}} onTouchStart={d}>
                        <h1>Phone</h1> 
                        <p>Send A Text</p> 
                        <p>267-584-8591</p>
                      </div>
                ...
                <div className="flip-card mb-4">
                    <div className="flip-card-inner e">
                      ...
                      <div className="flip-card-back" style={{backgroundColor:'palevioletred'}} onTouchStart={e}>
                        <h1>Resume</h1> 
                        <p>View My Resume</p> 
